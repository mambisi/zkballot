...
use crate::gadget::scalar_utils::{ScalarBytes, get_base_4_repr};
use crate::gadget::r1cs_utils::{AllocatedScalar, constrain_lc_with_scalar};
use crate::gadget::gadget_poseidon::{PoseidonParams, Poseidon_hash_4, Poseidon_hash_4_constraints, Poseidon_hash_4_gadget, SboxType,
