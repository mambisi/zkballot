...
use crate::gadget::scalar_utils::{ScalarBytes, ScalarBits, get_bits};
use crate::gadget::r1cs_utils::{AllocatedScalar, constrain_lc_with_scalar};
// use crate::gadget_mimc::{mimc, MIMC_ROUNDS, mimc_hash_2, mimc_gadget};
use crate::gadget::gadget_poseidon::{PoseidonParams, Poseidon_hash_2, Poseidon_hash_2_constraints, Poseidon_hash_2_gadget, SboxType,
